...
<link href="{{URL::asset('assets/plugins/attachments-comparsion/twentytwenty.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<script src="{{URL::asset('assets/plugins/attachments-comparsion/jquery.twentytwenty.js')}}"></script>
<script src="{{URL::asset('assets/plugins/attachments-comparsion/jquery.event.move.js')}}"></script>
